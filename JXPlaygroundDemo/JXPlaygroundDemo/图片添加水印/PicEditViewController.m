...
- (void)viewDidLoad {
    ...
    imageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 88, kScreenW-20, 200)];
    ...
    imageView2 = [[UIImageView alloc] initWithFrame:CGRectMake(10, 300, kScreenW-20, 200)];
