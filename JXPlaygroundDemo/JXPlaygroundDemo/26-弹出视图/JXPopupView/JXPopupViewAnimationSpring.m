...
#import "JXPopupViewAnimationSpring.h"

@interface JXPopupViewAnimationSpring ()<CAAnimationDelegate>

@property (nonatomic,copy)void (^completion)(void);

@end
@implementation JXPopupViewAnimationSpring
