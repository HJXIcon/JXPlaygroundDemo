...
@property (nonatomic, readonly) NSString *path;        ///< The path of this storage. /// storage 路径
@property (nonatomic, readonly) YYKVStorageType type;  ///< The type of this storage. /// storage 类型
@property (nonatomic) BOOL errorLogsEnabled;           ///< Set `YES` to enable error logs for debug. /// 是否开启错误日志
