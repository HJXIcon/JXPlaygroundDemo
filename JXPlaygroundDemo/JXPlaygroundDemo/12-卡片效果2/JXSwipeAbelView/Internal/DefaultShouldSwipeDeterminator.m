...
- (BOOL)isDirectionAllowed:(CGPoint)translation
          allowedDirection:(JXSwipeAbleViewDirection)allowedDirection {
    return (JXSwipeAbleViewDirectionFromPoint(translation) & allowedDirection) !=
           JXSwipeAbleViewDirectionNone;
}
