...
@implementation REListHeaderView

+ (REListHeaderView *)headerViewWithImageNamed:(NSString *)imageNamed username:(NSString *)username
{
    REListHeaderView *view = [[REListHeaderView alloc] initWithFrame:CGRectMake(0, 0, 320, 44)];
