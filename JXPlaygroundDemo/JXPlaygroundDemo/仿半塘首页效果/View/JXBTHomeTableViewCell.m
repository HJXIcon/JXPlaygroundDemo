...
@interface JXBTHomeTableViewCell ()
...
@end
@implementation JXBTHomeTableViewCell
...
- (void)setHomeRecomandModel:(JXBTHomeRecomandModel *)homeRecomandModel {
